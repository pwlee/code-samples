...
var _snakeGame = __webpack_require__(29);
...
var _snake = __webpack_require__(62);

var _snake2 = _interopRequireDefault(_snake);

var _wall = __webpack_require__(104);

var _wall2 = _interopRequireDefault(_wall);

var _food = __webpack_require__(102);
...
var _collisions = __webpack_require__(64);

var _collisions2 = _interopRequireDefault(_collisions);

var _directions = __webpack_require__(103);
...
var SnakeGame = function () {
  ...
  (0, _createClass3.default)(SnakeGame, [{
    ...
    value: function onKeyDown(e) {
      var newDirection = _directions.KEYCODES[e.keyCode];
      var oppositeDirection = _directions.OPPOSITE_DIRECTIONS[this.snake.direction];
...
var _snakeNode = __webpack_require__(63);
...
var _gameObject = __webpack_require__(101);
...
var Collision = function () {
  ...
  (0, _createClass3.default)(Collision, null, [{
    key: "aabb",

    // Axis-Aligned Bounding Box
    // Simple collision detection between two rectangles (does not account for rotation)
    // See: https://developer.mozilla.org/en-US/docs/Games/Techniques/2D_collision_detection
    value: function aabb(rect1, rect2) {
      return rect1.position.x < rect2.position.x + rect2.width && rect1.position.x + rect1.width > rect2.position.x && rect1.position.y < rect2.position.y + rect2.height && rect1.height + rect1.position.y > rect2.position.y;
    }
  }]);
  return Collision;
}();
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(38)(Function.call, __webpack_require__(71).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var OPPOSITE_DIRECTIONS = exports.OPPOSITE_DIRECTIONS = {};
...
var Wall = function (_GameObject) {
  (0, _inherits3.default)(Wall, _GameObject);
