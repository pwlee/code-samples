...
export default class ZoomIn extends ZoomButton {
  ...
  render() {
    return (
      <span className={'zoom-in' + (!this.isEnabled() ? ' disabled' : '')} onClick={this.handleClick.bind(this)} >
        <svg x="0px" y="0px" viewBox="0 0 80.3 80.3" role="img" aria-labelledby="zoom-in-svg zoom-in-svg-desc">
          <g>
