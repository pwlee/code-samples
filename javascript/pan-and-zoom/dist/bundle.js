...
var ZoomButton = function (_React$Component) {
  (0, _inherits3.default)(ZoomButton, _React$Component);

  function ZoomButton(props) {
    (0, _classCallCheck3.default)(this, ZoomButton);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ZoomButton.__proto__ || (0, _getPrototypeOf2.default)(ZoomButton)).call(this, props));
  ...
  (0, _createClass3.default)(ZoomButton, [{
    key: 'handleClick',
...
var _panZoom = __webpack_require__(74);
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(41),B=__webpack_require__(20),C=__webpack_require__(7),ba=__webpack_require__(42),da=__webpack_require__(43),ea=__webpack_require__(44),fa=__webpack_require__(45),ia=__webpack_require__(46),D=__webpack_require__(21);
...
var _pan = __webpack_require__(114);
...
var PanZoom = function (_React$Component) {
  (0, _inherits3.default)(PanZoom, _React$Component);

  function PanZoom() {
    (0, _classCallCheck3.default)(this, PanZoom);
    return (0, _possibleConstructorReturn3.default)(this, (PanZoom.__proto__ || (0, _getPrototypeOf2.default)(PanZoom)).apply(this, arguments));
  }

  (0, _createClass3.default)(PanZoom, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        { ref: 'panZoomContainer', className: 'pan-zoom-container' },
...
var Pan = function (_React$Component) {
  (0, _inherits3.default)(Pan, _React$Component);

  function Pan(props) {
    (0, _classCallCheck3.default)(this, Pan);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Pan.__proto__ || (0, _getPrototypeOf2.default)(Pan)).call(this, props));
  ...
  (0, _createClass3.default)(Pan, [{
    ...
    value: function pan(mouseEvent) {
      ...
      var newYTranslate = this.state.cumulativeOffsetY + yDifference;
      ...
      this.setState({
        translateX: [-maxXTranslate, newXTranslate, maxXTranslate].sort(function (a, b) {
          return a - b;
        })[1],
        translateY: [-maxYTranslate, newYTranslate, maxYTranslate].sort(function (a, b) {
          return a - b;
        })[1]
      });
    }
...
var _zoomIn = __webpack_require__(116);

var _zoomIn2 = _interopRequireDefault(_zoomIn);

var _zoomOut = __webpack_require__(117);
  ...
  (0, _createClass3.default)(Zoom, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_zoomIn2.default, { ref: 'zoomInComponent', onClick: this.zoomIn.bind(this) }),
        _react2.default.createElement(_zoomOut2.default, { ref: 'zoomOutComponent', onClick: this.zoomOut.bind(this) })
      );
    }
  }, {
    key: 'getZoomFactor',
...
var _zoomButton = __webpack_require__(60);

var _zoomButton2 = _interopRequireDefault(_zoomButton);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ZoomIn = function (_ZoomButton) {
  (0, _inherits3.default)(ZoomIn, _ZoomButton);

  function ZoomIn(props) {
    (0, _classCallCheck3.default)(this, ZoomIn);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ZoomIn.__proto__ || (0, _getPrototypeOf2.default)(ZoomIn)).call(this, props));

    _this.enable();
    return _this;
  }

  (0, _createClass3.default)(ZoomIn, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'span',
        { className: 'zoom-in' + (!this.isEnabled() ? ' disabled' : ''), onClick: this.handleClick.bind(this) },
        _react2.default.createElement(
          'svg',
          { x: '0px', y: '0px', viewBox: '0 0 80.3 80.3', role: 'img', 'aria-labelledby': 'zoom-in-svg zoom-in-svg-desc' },
          _react2.default.createElement(
            'g',
            null,
            _react2.default.createElement('path', { d: 'M78.8,73.3L57.7,52.2c-0.3-0.3-0.6-0.5-0.9-0.7c4.4-5.6,6.8-12.5,6.8-19.7c0-8.5-3.3-16.5-9.3-22.5c-6-6-14-9.3-22.5-9.3 C23.3,0,15.3,3.3,9.3,9.3c-12.4,12.4-12.4,32.6,0,45c6,6,14,9.3,22.5,9.3c7.2,0,14.1-2.4,19.7-6.8c0.2,0.3,0.4,0.6,0.7,0.9 l21.1,21.1c1.5,1.5,4,1.5,5.6,0C80.4,77.3,80.4,74.8,78.8,73.3z M51,51C45.9,56.2,39.1,59,31.8,59c-7.2,0-14.1-2.8-19.2-7.9 c-10.6-10.6-10.6-27.8,0-38.4c5.1-5.1,11.9-7.9,19.2-7.9c7.2,0,14.1,2.8,19.2,7.9c5.1,5.1,7.9,11.9,7.9,19.2 C59,39.1,56.1,45.9,51,51z' })
          ),
          _react2.default.createElement('path', { d: 'M43.5,29.1h-9.3v-9.3c0-1.3-1.1-2.4-2.4-2.4c-1.3,0-2.4,1.1-2.4,2.4v9.3h-9.3c-1.3,0-2.4,1.1-2.4,2.4c0,1.3,1.1,2.4,2.4,2.4 h9.3v9.3c0,1.3,1.1,2.4,2.4,2.4c1.3,0,2.4-1.1,2.4-2.4v-9.3h9.3c1.3,0,2.4-1.1,2.4-2.4C45.9,30.2,44.8,29.1,43.5,29.1z' })
        )
      );
    }
  }]);
  return ZoomIn;
}(_zoomButton2.default);
...
var ZoomOut = function (_ZoomButton) {
  (0, _inherits3.default)(ZoomOut, _ZoomButton);

  function ZoomOut(props) {
    (0, _classCallCheck3.default)(this, ZoomOut);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ZoomOut.__proto__ || (0, _getPrototypeOf2.default)(ZoomOut)).call(this, props));

    _this.disable();
    return _this;
  }

  (0, _createClass3.default)(ZoomOut, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'span',
        { className: 'zoom-out' + (!this.isEnabled() ? ' disabled' : ''), onClick: this.handleClick.bind(this) },
        _react2.default.createElement(
          'svg',
          { x: '0px', y: '0px', viewBox: '0 0 80.3 80.3', role: 'img', 'aria-labelledby': 'zoom-out-svg zoom-out-svg-desc' },
          _react2.default.createElement(
            'g',
            null,
            _react2.default.createElement('path', { d: 'M78.8,73.3L57.7,52.2c-0.3-0.3-0.6-0.5-0.9-0.7c4.4-5.6,6.8-12.5,6.8-19.7c0-8.5-3.3-16.5-9.3-22.5c-6-6-14-9.3-22.5-9.3 C23.3,0,15.3,3.3,9.3,9.3c-12.4,12.4-12.4,32.6,0,45c6,6,14,9.3,22.5,9.3c7.2,0,14.1-2.4,19.7-6.8c0.2,0.3,0.4,0.6,0.7,0.9 l21.1,21.1c1.5,1.5,4,1.5,5.6,0C80.4,77.3,80.4,74.8,78.8,73.3z M51,51C45.9,56.2,39.1,59,31.8,59c-7.2,0-14.1-2.8-19.2-7.9 c-10.6-10.6-10.6-27.8,0-38.4c5.1-5.1,11.9-7.9,19.2-7.9c7.2,0,14.1,2.8,19.2,7.9c5.1,5.1,7.9,11.9,7.9,19.2 C59,39.1,56.1,45.9,51,51z' })
          ),
          _react2.default.createElement('path', { d: 'M43.5,29H20.1c-1.3,0-2.4,1.2-2.4,2.5s1.1,2.5,2.4,2.5h23.4c1.3,0,2.4-1.2,2.4-2.5S44.8,29,43.5,29z' })
        )
      );
    }
  }]);
